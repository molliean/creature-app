    ...
    <div className="flex w-full gap-8 bg-[#CBDEE1] px-[10px] py-[10px]">
      <div className="flex gap-8">
        <div className="flex flex-col items-center justify-center gap-[3px]">
          <span className="font-dm-sans text-[17px] leading-[1.3em] text-black">
      ...
      <div className="flex items-center gap-8">
        {rest.map(({ item, index }) => (
          <button
            ...
            className="font-dm-sans text-[17px] leading-[1.3em] text-[#686868] hover:text-black transition-colors"
          >
